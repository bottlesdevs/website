...
time we have decided give some love to the display options. Those options are
now located in a dedicated dialog, which is much more intuitive and easy to
use.
...
unfortunately this is a very problematic and risky feature since some d
ependencies may not be incompatible with each other and may irreversibly 
damage the bottle. Therefore, we have decided to deprecate this feature.
...
Finally, improvements have also been made to the mobile. Now the interface is 
