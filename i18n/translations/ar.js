export const ar = {
    ...
    runners: {
        ...
        protosoda: {
            ...
            title: 'ProtoSoda',
            version: 'متوفر الآن مع Wine 11.0!',
            description1: 'يجلب ProtoSoda مشغل Soda إلى الألعاب التي تعمل عبر Proton وUMU. وهو المشغل الافتراضي لتكامل UMU الجديد في Bottles.',
            description2: 'يحتفظ بإصلاحات Soda ويوفر بيئة Proton التي يتطلبها UMU، لتستخدم الألعاب عائلة المشغلات نفسها داخل Bottle التقليدية وخارجها.',
            umu: 'جاهز لـ UMU',
            umuDesc: 'مصمم للألعاب التي يديرها تكامل UMU.',
            sodaCore: 'نواة Soda',
            sodaCoreDesc: 'يتضمن أعمال التوافق التي تتم صيانتها في Soda.',
        },
        caffe: {
            badge: 'الإرث والاستقرار',
            title: 'Caffe',
            upgrading: 'متوفر الآن مع Wine 10.0!',
    ...
    eaglePage: {
        hero: {
            ...
            description: 'يفحص Eagle ملفات ويندوز التنفيذية قبل تشغيلها، وينبهك إلى المشكلات المحتملة، ويجمع التحليل المحلي مع بيانات التوافق من المجتمع.',
            download: 'حمل Bottles',
        },
        howItWorks: {
            title: 'كيف يعمل Eagle؟',
            description: 'يتبع Eagle تحليلاً على مراحل ويربط كل نتيجة بالملف أو مصدر البيانات الذي أنتجها.',
            steps: {
                peParsing: {
                    title: 'تحليل PE',
                ...
                yaraScanning: {
                    title: 'فحص YARA',
                    description: 'تتعرف القواعد على عائلات البرامج والتوقيعات المعروفة المرتبطة بالبرمجيات الخبيثة وبرامج سرقة المعلومات.',
                },
                contextAnalysis: {
                    title: 'تحليل السياق',
                    description: 'يفحص الملفات المرتبطة ويبحث عن تطابق في قاعدة بيانات المجتمع المتاحة دون اتصال.',
                },
                suggestions: {
                    title: 'اقتراحات',
                    description: 'ينشئ اقتراحات اختيارية للاعتماديات والإعدادات اعتماداً على الأدلة التي وجدها.',
                },
            },
        },
        detection: {
            title: 'يعرف ما الذي يبحث عنه',
            description: 'يتعرف Eagle على واجهات الرسوميات والمحركات وبيئات التشغيل وأنظمة الحماية وصيغ التثبيت عبر بيانات PE واستيرادات DLL وقواعد YARA.',
            categories: {
        ...
        intelligence: {
            title: 'تحليل يراعي السياق',
            description: 'يجمع التقرير بين الفحص المحلي وتدقيق الأمان وأدلة المجتمع قبل أن تقرر ما الذي ستشغله أو تغيره.',
            features: {
                ...
                threatScanning: { title: 'فحص التهديدات', description: 'يفحص الملفات التنفيذية بحثاً عن أنماط معروفة للبرمجيات الخبيثة وسرقة المعلومات، ثم يحذرك قبل تشغيل برنامج تم تمييزه.' },
                communityEvidence: { title: 'أدلة المجتمع', description: 'يطابق البرامج مع تقارير ProtonDB غير المتصلة وبيانات تطبيقات winetricks المضمنة في Bottles.' },
                crashFollowUp: { title: 'تحليل بعد الإغلاق', description: 'يقترح تحليل Eagle عندما يغلق البرنامج فوراً لتسهيل مراجعة المكونات الناقصة والمشكلات المعروفة.' },
                smartSuggestions: { title: 'اقتراحات اختيارية', description: 'يقترح الاعتماديات ومتغيرات البيئة وتجاوزات DLL وخيارات التشغيل وبعض التحسينات عندما تدعمها الأدلة.' },
                transparentSources: { title: 'المصادر والتراخيص', description: 'يعرض نوع المطابقة والأدلة والمصدر ونسب البيانات والترخيص بجوار النتائج المشتقة من المجتمع.' },
            },
        },
        community: {
            ...
            winetricksTitle: 'بيانات تطبيقات winetricks',
        },
        report: {
            title: 'شفافية مطلقة',
            description: 'ينشئ Eagle تقارير Markdown يمكنك حفظها ومشاركتها. تبقى النتائج التقنية منفصلة عن أدلة المجتمع والتغييرات المقترحة.',
            items: [
                "بيانات الملف: البنية، تاريخ البناء، والناشر",
                "التقنيات المكتشفة مع تحديد ملفاتها المصدرية",
                "نتائج فحص التهديدات وتحذيرات التوافق",
                "نوع مطابقة المجتمع ودرجة الثقة والأدلة",
                "الاعتماديات المقترحة والإعدادات الاختيارية",
                "نسب مصادر البيانات وتراخيصها",
    ...
    funding: {
        ...
        goals: {
            nextBackend: {
                title: 'الواجهة الخلفية لـ Bottles Next',
                description: 'تدير واجهتنا الخلفية المكتوبة بلغة Rust الآن القوارير والمشغلات والمكونات والاعتماديات واللقطات والأغلفة وWine وProton وWineBridge.',
                info: 'أكملنا نطاق الواجهة الخلفية المطلوب لأول تطبيق من Bottles Next.',
            },
            nextUi: {
                title: 'مجموعة واجهة Next',
                description: 'نبني مكتبة مكونات Rust وIced التي ستحدد واجهة Bottles Next وأنماط التفاعل فيها.',
                info: 'يمكن استخدام معرض مكوناتنا الآن ونحن نضيف إليه أنماطاً جديدة للتطبيق.',
            },
            nextApp: {
                title: 'تطبيق Bottles Next',
                description: 'نربط next-ui بالواجهة الخلفية المكتملة ونحول المكونات الحالية إلى أول تطبيق سطح مكتب قابل للاستخدام.',
                info: 'التطبيق الرسومي هو خطوتنا الحالية بين الواجهة الخلفية المكتملة وأول معاينة عامة.',
            },
            layers: {
                title: 'القوارير ذات الطبقات',
                description: 'نحول عرض Flatpak العامل للبادئات ذات الطبقات إلى ميزة مدعومة في Bottles Next، مع طبقات قابلة لإعادة الاستخدام للتطبيقات والاعتماديات.',
                info: 'ينشئ نموذجنا الأولي الطبقات ويكون بادئة ويشغل تطبيق ويندوز حقيقياً.',
            },
            legacy: {
        ...
        roadmap: {
            title: 'أهداف التمويل الحالية',
            description: 'تعرّف على ما يدعمه وقت التطوير وتمويل المشروع حالياً.',
            searchPlaceholder: 'صفِّ المهام...',
        },
        tasks: {
            status: {
                wip: 'قيد التنفيذ',
