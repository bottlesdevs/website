export const ar = {
    ...
    features: {
        ...
        runnersCard: {
            badge: 'جوهر التقنية',
            title: 'قابل المشغلات',
            description: 'تعرف على مشغلات Wine وProton التي تتم صيانتها من أجل Bottles.',
            button: 'إقراء المزيد',
        },
        bottlesNext: {
            badge: 'الفصل التالي',
    ...
    runners: {
        ...
        vaniglia: {
            badge: 'مرجع WineHQ',
            title: 'Vaniglia',
            version: 'متوفر مع Wine 10.19!',
            description1: 'يبقى Vaniglia قريباً من WineHQ ويوفر لـ Bottles مشغل Wine تقليدياً للمقارنة والاختبار والبرامج التي لا تحتاج إلى بيئة Valve أو Proton.',
            description2: 'تستخدم بنياته مصدر WineHQ مع رقع Staging وواجهة Bottles المسطحة. وهو يدعم تطبيقات ويندوز ذات 32 و64 بت.',
            cleanBase: 'قاعدة WineHQ',
            cleanBaseDesc: 'مبني من مصدر إصدار WineHQ المطابق.',
            staging: 'يتضمن Staging',
            stagingDesc: 'يتضمن رقع Wine Staging لتوافق أوسع.',
        },
        crossover: {
            badge: 'فرع CodeWeavers',
            title: 'CrossOver',
            version: 'تتم صيانته مع Wine 21.2.0 CX!',
            description1: 'نحافظ أيضاً على بنية من مصدر Wine الذي تنشره CodeWeavers لـ CrossOver. وهي تتيح استخدام عملهم على التوافق كمشغل يمكن اختياره مباشرة في Bottles.',
            description2: 'يبقى هذا المشغل منفصلاً عن Vaniglia لأن مصدره ودورة إصداره يتبعان CrossOver بدلاً من WineHQ. وهو يدعم حالياً تطبيقات ويندوز ذات 64 بت.',
            codeweavers: 'مصدر CodeWeavers',
            codeweaversDesc: 'مبني من أرشيف المصدر المنشور لـ CrossOver.',
            compatibility: 'مسار منفصل',
            compatibilityDesc: 'مفيد للبرامج التي تستفيد من رقع CrossOver.',
            buildLabel: 'بنية من مصدر CodeWeavers',
            sourceLabel: 'المصدر',
            targetLabel: 'الهدف',
            statusLabel: 'الحالة',
            statusMaintained: 'تتم صيانته',
        },
        comparison: {
            ...
            codeweaversWine: 'Wine من CodeWeavers',
            ...
            followsCrossOver: 'يتبع CrossOver',
        },
        contribute: {
            badge: 'للمطورين',
