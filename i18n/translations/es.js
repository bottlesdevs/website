export const es = {
    ...
    features: {
        ...
        sandboxed: {
            title: 'Aislado',
            description: 'Flatpak sigue siendo el paquete aislado recomendado, mientras que la versión experimental de cpak ofrece otra forma oficial de instalar Bottles.',
        },
        versionManager: {
        ...
        runnersCard: {
            ...
            description: 'Conoce los runners Wine y Proton mantenidos para Bottles.',
    ...
    runners: {
        ...
        soda: {
            ...
            adaptiveLaunch: 'Inicio adaptativo',
            adaptiveLaunchDesc: 'Soda aprende qué archivos usa un programa durante el inicio y los prepara antes en los siguientes lanzamientos. Es el primer paso de una serie de actualizaciones dedicadas a hacer Soda más inteligente.',
            adaptiveLaunchRequires: 'Requiere Bottles 66 y soda-11.0-5 o posterior.',
        },
        protosoda: {
        ...
        vaniglia: {
            badge: 'Referencia WineHQ',
            title: 'Vaniglia',
            version: 'Disponible con Wine 10.19!',
            description1: 'Vaniglia se mantiene cerca de WineHQ y ofrece a Bottles un runner Wine tradicional para comparaciones, pruebas y software que no necesita la pila de Valve o Proton.',
            description2: 'Sus compilaciones usan el código fuente de WineHQ con los parches Staging y el tema plano de Bottles. Admite aplicaciones de Windows de 32 y 64 bits.',
            cleanBase: 'Base WineHQ',
            cleanBaseDesc: 'Compilado desde el código fuente de la versión WineHQ correspondiente.',
            staging: 'Staging incluido',
            stagingDesc: 'Incluye los parches Wine Staging para ampliar la compatibilidad.',
        },
        crossover: {
            badge: 'Rama CodeWeavers',
            title: 'CrossOver',
            version: 'Mantenido con Wine 21.2.0 CX!',
            description1: 'También mantenemos una compilación del código fuente Wine publicado por CodeWeavers para CrossOver. Lleva su trabajo de compatibilidad a un runner que se puede seleccionar directamente en Bottles.',
            description2: 'Este runner permanece separado de Vaniglia porque su código y ciclo de lanzamiento siguen CrossOver en lugar de WineHQ. Actualmente ejecuta aplicaciones de Windows de 64 bits.',
            codeweavers: 'Código de CodeWeavers',
            codeweaversDesc: 'Compilado desde el archivo de código fuente publicado para CrossOver.',
            compatibility: 'Rama separada',
            compatibilityDesc: 'Útil para software que se beneficia de los parches de CrossOver.',
            buildLabel: 'Compilación del código CodeWeavers',
            sourceLabel: 'código',
            targetLabel: 'destino',
            statusLabel: 'estado',
            statusMaintained: 'mantenido',
        },
        comparison: {
            ...
            codeweaversWine: 'Wine de CodeWeavers',
            ...
            crossoverApps: 'Compatibilidad CrossOver',
            ...
            followsCrossOver: 'Sigue CrossOver',
        },
        contribute: {
    ...
    eaglePage: {
        ...
        community: {
            ...
            description: 'Eagle Intelligence puede identificar aplicaciones conocidas y compararlas con informes de la comunidad sin enviar el ejecutable a ningún sitio. Los datos se incluyen en los paquetes oficiales de Bottles y no requieren una descarga aparte.',
    ...
    funding: {
        ...
        channels: {
            ...
            card: { name: 'Tarjeta de crédito/débito', desc: 'Pago único con tarjeta o Apple Pay' },
            revolut: { desc: 'Revolut, tarjeta o Apple Pay' },
        ...
        goals: {
            ...
            legacy: {
                ...
                description: 'Sigo manteniendo estable la versión actual de Bottles mientras construimos Next, con correcciones de compatibilidad, actualizaciones de Soda, Eagle y versiones de los paquetes oficiales.',
            ...
            umu: {
                title: 'UMU en Bottles Legacy',
                description: 'UMU ya tiene una integración gráfica completa en la Biblioteca, con prefijos gestionados, ajustes por juego, dependencias y ProtoSoda.',
                info: 'La integración de UMU está completa y llegará con Bottles 66.',
            },
        },
        roadmap: {
    ...
    download: {
        ...
        otherVersions: {
            ...
            v1: { title: 'Bottles Original', desc: 'La experiencia Bottles original, aún disponible para quienes prefieren su flujo más sencillo.' },
        ...
        cpak: {
            title: 'cpak',
            desc: 'El segundo paquete oficial de Bottles, disponible ahora para pruebas experimentales.',
            badge: 'EXPERIMENTAL',
            button: 'Probar Bottles con cpak'
        },
        thankYou: {
            title: '¡Gracias por descargar!',
            desc: 'Elige cómo instalar Bottles y pulsa uno de los botones de abajo.',
        ...
        modal: {
            ...
            donatePaypal: 'Donar con PayPal y descargar',
            donateCard: 'Tarjeta de crédito/débito',
