export const es = {
    ...
    runners: {
        ...
        soda: {
            ...
            valveWineDesc: 'Construido sobre la misma base Wine usada por Steam Deck.',
            patches: 'Parches curados',
            patchesDesc: 'Incluye las mejores correcciones de TKG, GE y Proton.',
        },
        protosoda: {
            badge: 'Para Proton y UMU',
            title: 'ProtoSoda',
            version: 'Disponible ahora con Wine 11.0!',
            description1: 'ProtoSoda lleva Soda a los juegos iniciados mediante Proton y UMU. Es el runner predeterminado para la nueva integración UMU en Bottles.',
            description2: 'Conserva las correcciones desarrolladas para Soda y proporciona el entorno Proton requerido por UMU, por lo que los juegos pueden usar la misma familia de runners dentro y fuera de una Bottle tradicional.',
            umu: 'Preparado para UMU',
            umuDesc: 'Creado para juegos administrados mediante la integración UMU.',
            sodaCore: 'Núcleo de Soda',
            sodaCoreDesc: 'Incluye el trabajo de compatibilidad mantenido para Soda.',
        },
        caffe: {
            badge: 'Legacy y estabilidad',
            title: 'Caffe',
            upgrading: '¡Disponible ahora con Wine 10.0!',
